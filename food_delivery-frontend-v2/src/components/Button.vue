    ...
    switch (props.type) {
      case 'primary':
        return !props.disabled
            ...
            : 'bg-primary-disabled border-neutral-0 border-2 h-12 hover:bg-blue-75 hover:text-black active:transform-cpu font-medium transition duration-300 ease-in-out text-white'
      case 'secondary':
...
<template>
  <button class="px-3.5 py-1.5 font-sans rounded-xl flex items-center justify-center" :class="buttonClass">
    <slot></slot>
  </button>
</template>
